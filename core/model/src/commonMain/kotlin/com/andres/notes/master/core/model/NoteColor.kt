...
// TODO: It is not protected from obfuscation.
@Deprecated("Should be replaced with more flexible solution to have opportunity use not only values from this list")
